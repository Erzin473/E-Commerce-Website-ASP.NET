<%@ Page Title="" Language="C#" MasterPageFile="~/GeneralLayout.Master" AutoEventWireup="true" CodeBehind="Payment.aspx.cs" Inherits="WebApp.Payment" %>
            ...
            <div class="col-md-12">
                ...
                <div class="tab-content">
                    <div id="wallets" class="tab-pane fade show active">
                        <h3>HOME</h3>
                        <p>Some content.</p>
                        <asp:Button ID="btnPaytm" OnClick="btnPaytm_Click" runat="server" Text="Stripe" />
                    </div>
                    ...
                    <div id="cod" class="tab-pane fade">
                        ...
                        <p>Some content.</p>
                           <asp:Button ID="btnCod" OnClick="btnCod_Click" runat="server" Text="Cash on delivery" />
                    </div>
                </div>
            </div>
        </div>
