        ...
        protected void btPassRec_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(CS))
            {
                ...
                if (dt.Rows.Count != 0)
                {
                    ...
                    String EmailBody = "Hi"+Username+ ",<br/><b/> Click the link below to reset your password <br/><br/> https://localhost:44312/RecoverPassword.aspx?Uid="+myGUID;
                    ...
                    SMTP.Credentials = new NetworkCredential()
                    {
                        ...
                        Password = "yourpasswordl@gmail.com"
                    };
                    SMTP.EnableSsl = true;
                ...
                {
                    lblPassRec.Text = "This email id DOES NOT exist in our database !";
