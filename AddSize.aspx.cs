...
namespace WebApp
{
    public partial class AddSize : System.Web.UI.Page
    {
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(CS))
            {
                SqlCommand cmd = new SqlCommand("insert into tblSizes values(@txtSizeName , @ddlBrand , @ddlCategory , @ddlSubCat , @ddlGender)", con);
                
                cmd.Parameters.AddWithValue("@txtSizeName", txtSizeName.Text);
                cmd.Parameters.AddWithValue("@ddlBrand", ddlBrand.SelectedItem.Value);
                cmd.Parameters.AddWithValue("@ddlCategory", ddlCategory.SelectedItem.Value);
                cmd.Parameters.AddWithValue("@ddlSubCat", ddlSubCat.SelectedItem.Value);
                cmd.Parameters.AddWithValue("@ddlGender", ddlGender.SelectedItem.Value);
                con.Open();
                cmd.ExecuteNonQuery();
