...
namespace WebApp
{
    public partial class AddSubCategory : System.Web.UI.Page
    {
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(CS))
            {
                SqlCommand cmd = new SqlCommand("insert into tblSubCategories values(@txtSubCatName , @ddlCategory )", con);
                cmd.Parameters.AddWithValue("@txtSubCatName", txtSubCatName.Text);
                cmd.Parameters.AddWithValue("@ddlCategory", ddlCategory.SelectedValue);
                con.Open();
                cmd.ExecuteNonQuery();
